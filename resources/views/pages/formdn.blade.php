...
<div class="main-w3layouts wrapper">
    <!-- Thông báo nếu tồn tại session message -->
            <?php
             $message= Session::get('message');
             $messageok= Session::get('messageok');
            ...
            <?php
              ...
              if($messageok){//nếu tồn tại message thì in thông báo ra
            ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong style=" font-size: 20px">{{$messageok}}</strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
               Session::put('messageok',null);//Cho thông báo chỉ hiện 1 lần
             }
            ?>
    <div class="container" id="container">
        <div class="form-container form2-container">
            <!-- đăng ký -->
        <form name="form2" id="ff2"  method="POST" action="{{URL::to('/add-customer')}}" role="form" class="needs-validation" novalidate>
            {{csrf_field()}}              
            <div class="mb-3">
                <h2>TẠO TÀI KHOẢN</h2>
                <div class="form-group">
                    <input   type="text" data-validation="length" id="name" name="customer_name" data-validation-length="min3" 
                    data-validation-error-msg="nhập ít nhất 3 kí tự"  class="text" placeholder="Họ và tên" name="customer_name" value="" required/>
		    ...
		    <button type="submit" ><a style="color:black"class="btn ghost" >Đăng ký</a></button>
		</form>
    </div>
    <div class="form-container form1-container">
 
        <form name="form2" id="ff2"  method="POST" action="{{URL::to('/login-customer')}}" role="form" class="needs-validation" novalidate>
            {{csrf_field()}}             
            <h2>ĐĂNG NHẬP</h2>	
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="bubbles">
                    ...
                    <button class="ghost" id="form2btn"><a style="color:black"class="btn ghost" >Đăng nhập</a></button><br>
                ...
                <div class="bubbles">
                    ...
                    <button class="ghost" id="form1btn" href="formdk.php"><a style="color:black"class="btn ghost" >Đăng ký</a></button><br>
                    <button class="ghost" id="home" ><a style="color:black" class="btn" href="{{URL::to('/')}}">Home</a></button>
