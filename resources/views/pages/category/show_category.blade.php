		...
		<div class="container">
			<div class="row">
				...
				<ol class="breadcrumb" style="height:55px;text-align: center;vertical-align: middle;">
					...
					<li class="breadcrumb-item active" aria-current="page" style="padding-top:18px"><a href="">{{$category_name->category_name}}</a></li>
				</ol>
				</nav>
			...
			<div class="row">
				<div id="main-content" class="col-md-8">
					<div class="row">
						<div class="col-md-12">
							<div class="products">
							@foreach($category_book as $key => $book )
								<div class="col-lg-4 col-md-4 col-xs-12" style="min-height:520px">
									<div class="product" style="width:220px; margin:20px">
										<div class="image">
											<a href="{{URL::to('/chi-tiet-sach/'.$book->book_id)}}">
												<img src="{{URL::to('public/uploads/book/'.$book->book_image)}}" style="width:320px;height:300px"/>
											</a>
										</div>
										<div class="caption">
											<div class="name" style="height:70px"><h3><a href="{{URL::to('/chi-tiet-sach/'.$book->book_id)}}">{{$book->book_name}}</a></h3></div>
										...
										if($book->book_inventory==0){?>
											<div class="btn btn-1 add-to-cart" style="font-size:15px;background-color:#DF7857" >Hết hàng!!!</div>
										<?php
										}else{
										?>
							...
							{{ $category_book->links('pagination::bootstrap-4') }}
						</div>
